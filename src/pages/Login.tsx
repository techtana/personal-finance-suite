    ...
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#eceef2' }}>
      <div className="bg-white rounded-2xl shadow-xl p-10 w-full max-w-sm text-center">
        ...
        <p className="text-sm mb-8" style={{ color: '#5c6473' }}>
          Your data lives in your Google Drive — no third-party servers.
        </p>

        <button
          onClick={() => startAuthFlow()}
          className="w-full flex items-center justify-center gap-3 py-3 px-5 rounded-xl border border-[#d1d5db] bg-white font-semibold text-[#0f172a] hover:bg-[#f4f6f9] transition-colors text-sm"
        >
        ...
        <p className="text-xs mt-6" style={{ color: '#5c6473' }}>
          Requests <code className="bg-[#eceef2] px-1 rounded">drive.file</code> scope only —
          access limited to files created by this app.
        </p>
      </div>
    </div>
  )
